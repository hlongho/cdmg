...
class MoTa extends StatefulWidget {
  const MoTa({super.key});

  @override
  _moTa createState() => _moTa();
}

class _moTa extends State<MoTa> {
  int tieudelength = 0;
  int tongTien = 0;
    ...
    return Column(
      ...
      children: [
        ...
        OptionText(
            ...
            datas: huongNhas,
            callbackFunction: cbHuongBanCong,
