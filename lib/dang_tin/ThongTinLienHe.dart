...
class ThongTinLienHe extends StatelessWidget {
  ThongTinLienHe({super.key});
      ...
      children: [
        ...
        OptionText(
            ...
            callbackFunction: (itemSlected) {
              _thongTinLienHeModel.loaiTin = itemSlected;
            },
        ...
        OptionText(
          ...
          datas: soTuanDangs,
          callbackFunction: (itemSlected) {
            _thongTinLienHeModel.soTuanDang = itemSlected;
          },
